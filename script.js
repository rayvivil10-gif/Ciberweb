...
// Affiche directement les chiffres clés (audits, clients...) à leur valeur
// finale, indépendamment du reste — pour qu'ils s'affichent quoi qu'il arrive.
...
function initChatbot() {
  ...
  // Message d'accueil ajouté immédiatement (le bouton étant déjà géré en HTML,
  // le JS n'a pas besoin de réagir à l'ouverture pour l'afficher).
