...
/* ---------- 0. Écran de démarrage (splash screen) ---------- */
function initSplashScreen() {
  ...
  // Délai fixe : ne dépend pas du chargement complet de toutes les
  // ressources (polices, scripts externes...), qui peut être lent ou
  // bloqué sur certaines connexions et empêcher l'écran de disparaître.
  setTimeout(() => {
